...
class DbSetup:
	...
	def s_body(self):
		self.run([
			...
			"START",
			"CREATE TABLE project (id integer primary key, name text, burnIn integer, runLength integer, climateMap text)",
			...
			"CREATE TABLE carrier (id integer primary key, scenarioId integer, carrier text, subItem text, item text, itemId integer, source text)",
			"CREATE TABLE units (id integer primary key, scenarioId integer, subItem text, item text, itemId integer, source text, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE carrierRate (id integer primary key, scenarioId integer, carrier text, subItem text, item text, itemId integer, source text, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE carriersPerUnit (id integer primary key, scenarioId integer, carrier text, subItem text, item text, itemId integer, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE carrierInfectionRate (id integer primary key, scenarioId integer, carrier text, subItem text, item text, itemId integer, source text, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE preborderDetection (id integer primary key, scenarioId integer, carrier text, subItem text, item text, itemId integer, source text, detectionRate double, treatmentRateForUndetected double, treatmentEfficacy double)",
			"CREATE TABLE pathwayDetection (id integer primary key, scenarioId integer, carrier text, item text, itemId integer, pathwayPoint text, pathwayPointId integer, detectionRate double, treatmentRateForUndetected double, treatmentEfficacy double)",
			"CREATE TABLE carrierDailyMortalityRate (id integer primary key, scenarioId integer,  carrier text, item text, itemId integer, pathwayPoint text, pathwayPointId integer, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE pathogenDailyMortalityRate (id integer primary key, scenarioId integer,  carrier text, item text, itemId integer, pathwayPoint text, pathwayPointId integer, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE carrierDailyExitRate (id integer primary key, scenarioId integer,  carrier text, item text, itemId integer, pathwayPoint text, pathwayPointId integer, jan double, feb double, mar double, apr double, may double, jun double, jul double, aug double, sep double, oct double, nov double, dec double)",
			"CREATE TABLE carrierDispersal (id integer primary key, scenarioId integer, carrier text, sd double)",
			"CREATE TABLE transmissionRate (id integer primary key, scenarioId integer, carrier text, favourable double, suitable double, marginal double, unsuitable double)",
			"CREATE TABLE hostMortalityRate (id integer primary key, scenarioId integer, favourable double, suitable double, marginal double, unsuitable double)",
			...
			"CREATE TABLE establishmentMortalityRate (id integer primary key, scenarioId integer, favourable double, suitable double, marginal double, unsuitable double)",
			"CREATE TABLE establishmentDetection (id integer primary key, scenarioId integer, detectionRate double, treatmentRateForUndetected double, treatmentEfficacy double)",
			...
			"CREATE TABLE landSuitability (id integer primary key, scenarioId integer, landcover text, landcoverId integer, suitability integer)",
			"CREATE TABLE consequences (id integer primary key, scenarioId integer, landcover text, landcoverId integer, econEstab double, econSpread double, environEstab double, environSpread double, healthEstab double, healthSpread double, socialEstab double, socialSpread double)",



			# "CREATE TABLE consequences (id integer primary key, scenarioId integer, landcover text, landcoverId integer, ECON_EST double, ECON_SPREAD double, ENV_EST double, ENV_SPREAD double, SOC_EST double, SOC_SPREAD double, HEALTH_EST double, HEALTH_SPREAD double)", 
